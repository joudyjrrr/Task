      ...
      <div className=" flex flex-col gap-8 w-full px-4">
        ...
        <div className="flex flex-col gap-8 w-[45.5rem]">
          ...
          <div className="flex flex-col gap-3 w-full">
            <Button
              className="w-full bg-Brand-600 !text-Base-White font-semibold leading-4 text-Text-md border border-Brand-600"
            >
              Add Offer
            </Button>

            <Button>
              <Button onClick={changeStepHandler} className="w-full bg-white border border-Gray-300 text-Gray-700 font-semibold leading-6 text-Text-md shadow-none">
                Back
              </Button>
            </Button>
          </div>
