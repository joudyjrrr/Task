...
import Support from "../../../Assets/SVGs/Dashboard/SideBar/life-buoy-01.svg";
import Settings from "../../../Assets/SVGs/Dashboard/SideBar/settings-01.svg";
...
const page = () => {
  ...
  return (
    <div className="flex  auto-cols-auto   flex-col items-start gap-24 overflow-y-scroll  w-fit top-0 bg-white border-e border-gray-300">
      <div className="flex pt-8  px-5 flex-col gap-6">
        <div className="flex  gap-1 items-start">
          <Image alt="Avatr" src={Group} className="w-[1.76569rem] h-8 " />
          <Image alt="Avatr" src={Logo} className="w-[4.44856rem] h-6  mt-2" />
        </div>
        <div className="flex  px-[0.875rem] items-center gap-2 rounded-lg border border-gray-300 shadow-sm ">
        ...
        <div className="flex flex-col px-4 gap-2 items-start ">
          {dashBoardNavLinks.map((link: any) => (
            <div className="flex px-3 py-2 gap-2">
              {link.icon}
              <Link href={link.href} className="text-gray-800 text-Text-md font-sm leading-6 cursor-pointer">
                {link.title}
              </Link>
            </div>
          ))}
        ...
        <div id="footer" className="flex flex-col gap-6  pb-8 items-start ">
          <div className="flex flex-col px-4 gap-2 items-start ">
            <div className="flex px-3 py-2 gap-2">
              <Image alt="Avatr" src={Support} className="w-6 h-6" />
              <p className="text-gray-800 text-Text-md font-sm leading-6 ">
                Support
              </p>
            </div>
            <div className="flex px-3 py-2 gap-2">
              <Image alt="Avatr" src={Settings} className="w-6 h-6" />
              <p className="text-gray-800 text-Text-md font-sm leading-6 ">
                Settings
              </p>
            </div>
